...
public class DtTagAction {
	...
	public DataApiResponse<DtTag> get(@PathVariable("id")Long id) {
		BaseUserInfo user = (BaseUserInfo) SsoContext.getUser();
		System.out.println(user.getUserId());
		DtTag m = dtTagService.get(id);
		DataApiResponse<DtTag> apiResp = new DataApiResponse<>();
		apiResp.setData(m);
		return apiResp;
	}
	...
	public ApiResponse doSave(@RequestBody DtTag body) {
