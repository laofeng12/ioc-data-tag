 ...
 *
 */
public class DtTaggUpdateLogDBParam extends RoDBQueryParam {
	private Long eq_id;//日志编号 --主键查询
	
	private Long eq_taggId;//标签组编号 = ?
	...
	public Long getEq_taggId() {
		return eq_taggId;
	}
	public void setEq_taggId(Long taggId) {
		this.eq_taggId = taggId;
	}
